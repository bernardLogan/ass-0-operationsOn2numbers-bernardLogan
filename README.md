...
- create simple constructor classes (add, subtract)
- create interfaces (Has2numbers, oop.Multiply, oop.Add, oop.Subtract), 
...
- create child class (MultiplyOperatorFor2numbers) that extend an abstract base
 (OperatorFor2numbers) and implement an interface (oop.Multiply/Divide/Add/Subtract)
